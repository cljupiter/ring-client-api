...
var logger_1 = require("@eneris/push-receiver/dist/utils/logger");
var debugLogger = (0, debug_1["default"])('ring'), uuidNamespace = 'e53ffdc0-e91d-4ce1-bec2-df939d94739d';
var logger = {
...
function logInfo() {
    ...
    logger.logInfo.apply(logger, message);
}
