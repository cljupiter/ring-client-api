    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    e_1 = _b.sent();
                    if (!(!e_1.response && !requestOptions.allowNoResponse)) return [3 /*break*/, 4];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = {};
                        return [4 /*yield*/, this.hardwareIdPromise];
                    case 1: return [2 /*return*/, _a.apply(void 0, [(_b.json = (_c.device = (_d.hardware_id = _e.sent(),
                                _d.metadata = this.baseSessionMetadata,
                                _d.os = 'android',
                                _d),
                                _c),
                                _b.method = 'POST',
